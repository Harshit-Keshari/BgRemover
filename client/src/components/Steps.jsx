      ...
      <div className='flex items-start flex-wrap gap-4 mt-16 xl:mt-24 justify-center'>
        <div className='flex items-start gap-4 bg-white border drop-shadow-md p-7 pb-10 rounded hover:scale-105 transition-all duration-500'>
            ...
            <div>
                ...
                <p className='text-sm text-neutral-500 mt-1'>Upload your image by clicking on <br />upload button</p>
            </div>
        </div>
        <div className='flex items-start gap-4 bg-white border drop-shadow-md p-7 pb-10 rounded hover:scale-105 transition-all duration-500'>
            ...
            <div>
                ...
                <p className='text-sm text-neutral-500 mt-1'>Simply after upload you will <br />get your image without bg</p>
            </div>
        </div>
        <div className='flex items-start gap-4 bg-white border drop-shadow-md p-7 pb-10 rounded hover:scale-105 transition-all duration-500'>
            ...
            <div>
                ...
                <p className='text-sm text-neutral-500 mt-1'>Download you image by clicking on <br />download button</p>
            </div>
        </div>
